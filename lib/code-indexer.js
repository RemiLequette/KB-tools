 ...
 *   - indexRepo(db, repo, rootDir, extensions, exclude)  — scan and index all matching files under a directory
 *
 ...
 * @convention conventions/mcp-code-index.md [## What — Model > Scope > Exclude patterns]
 */
 ...
 *   conventions/mcp-code-index.md [## What — Model > Scope > Exclude patterns].
 */
export function indexRepo(db, repo, rootDir, extensions, exclude) {
  const files = fsScan.scanFiles(rootDir, extensions, exclude);
